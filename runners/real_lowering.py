...
class PrecisionType(Enum):
    ...
    RATIONAL = dace.rational  # Using actual dace rational type
...
class SDFGTypeLowerer:
    ...
    def lower_precision(self) -> Tuple[PrecisionType, Dict[str, Any]]:
        ...
        reference_sdfg = self.create_typed_sdfg(PrecisionType.RATIONAL)
        ...
        # Test from lowest precision to highest (excluding RATIONAL)
